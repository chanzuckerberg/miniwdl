...
is "$(grep NameCollision optimus.out | wc -l)" "3" "Optimus.wdl NameCollision"
is "$(cat optimus.out | wc -l)" "77" "Optimus.wdl output"
...
is "$(cat optimus_smartseq2.out | wc -l)" "109" "Optimus.wdl and SmartSeq2SingleSample.wdl output"
...
is "$(grep '(trivial_type_error.wdl Ln 2 Col 13) Expected Int instead of Boolean' trivial_type_error.err | wc -l)" "1" "trivial_type_error.wdl error message line 1"
is "$(grep '        Int x = false' trivial_type_error.err | wc -l)" "1" "trivial_type_error.wdl error message line 2"
