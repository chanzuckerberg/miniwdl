...
@test_corpus(
    ...
    expected_lint={'UnusedImport': 2, 'NameCollision': 13, 'ArrayCoercion': 2, 'NonemptyArrayCoercion': 1, 'StringCoercion': 1, 'OptionalCoercion': 3, 'UnnecessaryQuantifier': 2, 'UnusedDeclaration': 3, 'StrayInputDeclaration': 2, 'IncompleteCall': 2},
...
@test_corpus(
    ["test_corpi/contrived/**"],
    expected_lint={'OptionalCoercion': 4, 'UnusedDeclaration': 4, 'UnusedImport': 2, 'NameCollision': 13, 'ArrayCoercion': 2, 'NonemptyArrayCoercion': 1, 'StringCoercion': 1, 'UnnecessaryQuantifier': 2, 'StrayInputDeclaration': 2, 'IncompleteCall': 2},
    check_quant=False,
)
