...
def link_outputs_relative(
    ...
    def map_path_relative(v: Union[Value.File, Value.Directory]) -> str:
        ...
        if target:
            ...
            elif path_really_within(target, run_dir):
                # target is an out/ link generated by a call in the current workflow (task or
                # subworkflow); use the link's path relative to that out/ dir
